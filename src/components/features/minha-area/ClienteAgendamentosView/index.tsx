...
import { AgendamentoCard } from '@/components/features/agendamentos/AgendamentoCard';
                    ...
                    <div className="flex flex-col gap-3">
                      {lista.map((a) => (
                        <AgendamentoCard
                          key={a.id}
                          agendamento={a}
                          foto={animais.find((p) => p.id === a.animalId)?.foto ?? null}
                          isExpanded={expandedAg === a.id}
                          onToggle={() => setExpandedAg(expandedAg === a.id ? null : a.id)}
