            ...
            <main className="flex-grow flex flex-col items-center p-0 w-full">
                <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between py-16 px-4 md:px-8 bg-white rounded-lg mt-10">
                    ...
                    <div className="w-full md:w-1/2 md:pr-8 mb-8 md:mb-0">
                        ...
                        <p className="text-base md:text-lg text-gray-700 mb-4 md:mb-6">
                            Também entendemos a importância da prevenção e da educação. Por isso, promovemos campanhas de conscientização sobre saúde animal e oferecemos workshops para tutores sobre cuidados preventivos e primeiros socorros para pets. Nossa missão vai além do atendimento clínico, buscando sempre fortalecer o vínculo entre você e seu animal de estimação.
                        </p>
                    </div>
