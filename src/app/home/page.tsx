  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <main className="flex-grow flex flex-col items-center p-0 w-full">
        ...
        {/* Adicionando a barra separadora */}
        <hr className="border-t-2 border-gray-300 my-8" />

        {/* Alinhando e centralizando os itens */}
        <div className="w-full max-w-4xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-center items-start gap-8">
            <div className="md:w-1/2 text-left">
              <h3 className="text-xl font-semibold mb-2 text-center">Nossos Serviços Incluem:</h3>
            ...
            {/* Barra separadora entre as colunas */}
            <div className="hidden md:block md:h-auto md:w-px bg-gray-300"></div>

            <div className="md:w-1/2 text-left">
              <h3 className="text-xl font-semibold mb-2 text-center">Por que Escolher a [Nome da Clínica Veterinária]?</h3>
              <ul className="list-disc list-inside">
        ...
        {/* Último parágrafo centralizado e agrupado */}
        <div className="w-full max-w-2xl mx-auto text-center mt-8 px-4">
          <p className="text-lg mb-8">
