      ...
      <main className="flex-grow flex flex-col justify-center items-center p-4 w-full">
        <div className="w-full max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg my-8">
          ...
          <button
            ...
            className="w-full bg-green-600 text-white font-bold py-2 px-4 rounded-lg border border-green-600 transition duration-300 hover:bg-white hover:text-green-600"
          >
            Enviar via WhatsApp
          </button>
        </div>
